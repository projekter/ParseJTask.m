...
parseJTask$parsecone["rquad",items_,_,True]:=VectorGreaterEqual[{{(items[[1]]-items[[2]])/Sqrt[2],Splice[items[[3;;]]],(items[[1]]+items[[2]])/Sqrt[2]},0},"NormCone"]&&items[[1]]>=0&&items[[2]]>=0;
parseJTask$parsecone["rquad",items_,_,False]:=2items[[1]]items[[2]]>=Total[items[[3;;]]^2]&&items[[1]]>=0&&items[[2]]>=0;
